        ...
        for(int i = 0;i < s.size();i++)
        {
            ...
            if(mp.find(curChar) != mp.end())
            {
                ...
                if (nextIndex < s.size())
                {
                    ...
                    if (mp.find(nextChar) != mp.end())
                    {
                        int nextValue = mp[nextChar];
                        if (curValue < nextValue)
                        {
                            res += (nextValue - curValue);
                            i = i + 1;
                        }
                    }
                }
